...
// CHECK:         "lazycst.expr"() <{inputs = [], outputs = [#lazycst.lazy_elms<@lazycst.0> : tensor<f32>], sym_name = "lazycst.0"}> ({
...
// CHECK:         "lazycst.expr"() <{inputs = [], outputs = [#lazycst.lazy_elms<@lazycst.0> : tensor<5xf32>], sym_name = "lazycst.0"}> ({
...
// CHECK:         "lazycst.expr"() <{inputs = [], outputs = [#lazycst.lazy_elms<@lazycst.1> : tensor<f32>], sym_name = "lazycst.1"}> ({
...
// CHECK:         "lazycst.expr"() <{inputs = [#lazycst.lazy_elms<@lazycst.0> : tensor<f32>], outputs = [#lazycst.lazy_elms<@lazycst.1> : tensor<f32>], sym_name = "lazycst.1"}> ({
// CHECK:         ^bb0([[ARG_0_:%.+]]: tensor<f32>):
