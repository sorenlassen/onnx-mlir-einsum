...
// CHECK-DAG:       [[VAR_0_:%.+]] = "krnl.global"() {name = "constant_14", shape = [], value = dense<0.000000e+00> : tensor<f32>} : () -> memref<f32>
...
// CHECK-DAG:         [[VAR_7_:%.+]] = "krnl.global"() {name = "constant_15", shape = [], value = dense<-1> : tensor<i32>} : () -> memref<i32>
...
// CHECK-DAG:           [[VAR_14_:%.+]] = "krnl.global"() {name = "constant_16", shape = [], value = dense<1> : tensor<i32>} : () -> memref<i32>
// CHECK:               [[VAR_15_:%.+]] = builtin.unrealized_conversion_cast [[VAR_14_]] : memref<i32> to tensor<i32>
// CHECK:               scf.yield [[VAR_14_]] : memref<i32>
// CHECK:             } else {
// CHECK:               [[VAR_14_1_:%.+]] = "krnl.global"() {name = "constant_17", shape = [], value = dense<0> : tensor<i32>} : () -> memref<i32>
