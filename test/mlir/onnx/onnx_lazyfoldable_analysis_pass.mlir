// RUN: onnx-mlir-opt --lazyfoldable-analysis-pass --hideDensifiableElementsAttrs=false %s -split-input-file | FileCheck %s
...
// CHECK:           [[VAR_2_:%.+]] = "onnx.Add"([[VAR_0_]], [[VAR_1_]]) {lazyfoldable} : (tensor<f32>, tensor<f32>) -> tensor<f32>
...
// CHECK-DAG:       [[VAR_4_:%.+]] = "onnx.Add"([[VAR_0_]], [[VAR_1_]]) {lazyfoldable} : (tensor<5xf32>, tensor<f32>) -> tensor<5xf32>
// CHECK-DAG:       [[VAR_5_:%.+]] = "onnx.Add"([[VAR_2_]], [[VAR_3_]]) {lazyfoldable} : (tensor<f32>, tensor<f32>) -> tensor<f32>
