...
// COM: CHECK-DAG:       [[CST_2000_:%.+]] = arith.constant 2000 : i64
// COM: CHECK-DAG:       [[CST_2800_:%.+]] = arith.constant 2800 : i64
...
// CHECK-DAG:       [[VAR_1_:%.+]] = memref.alloc() {{.*}}: memref<{{.*}}xi8>
// CHECK-NOT: separator of consecutive DAGs
// COM: CHECK-DAG:       [[VAR_2_:%.+]] = "krnl.getref"([[VAR_1_]], [[CST_2800_]]) : (memref<{{.*}}xi8>, i64) -> memref<10x10xf32>
// COM: CHECK-DAG:       [[VAR_3_:%.+]] = "krnl.getref"([[VAR_1_]], [[CST_2000_]]) : (memref<{{.*}}xi8>, i64) -> memref<10x20xf32>
// CHECK-DAG:       [[VAR_4_:%.+]] = "krnl.getref"([[VAR_1_]], [[CST_1200_]]) : (memref<{{.*}}xi8>, i64) -> memref<10x{{.*}}xf32>
// CHECK-DAG:       [[VAR_5_:%.+]] = "krnl.getref"([[VAR_1_]], [[CST_800_]]) : (memref<{{.*}}xi8>, i64) -> memref<10x10xf32>
// CHECK-DAG:       [[VAR_6_:%.+]] = "krnl.getref"([[VAR_1_]], [[CST_0_1_]]) : (memref<{{.*}}xi8>, i64) -> memref<10x20xf32>
// CHECK-DAG:       [[VAR_0_:%.+]] = memref.alloc() {{.*}}: memref<10x20xf32>
// CHECK:           memref.dealloc [[VAR_1_]] : memref<{{.*}}xi8>
