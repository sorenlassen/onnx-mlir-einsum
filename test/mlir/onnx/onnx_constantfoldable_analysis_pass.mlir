...
// RUN: onnx-mlir-opt --constantfoldable-analysis-pass --external-data-dir=. --hideDenseLikeElementsAttrs=false %s -split-input-file | FileCheck %s
// COM: onnx-mlir-opt --constantfoldable-analysis-pass --external-data-dir=. %s -split-input-file | FileCheck %s
