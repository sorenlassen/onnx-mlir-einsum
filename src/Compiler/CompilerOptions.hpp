...
extern std::vector<std::string> externalDataDir;              // common for both
extern bool hideDensifiableElementsAttrs;                     // common for both
...
extern bool onnxImportLazyCstFileData;                        // onnx-mlir only
