...
struct BTypeTraitBase {
  ...
  static constexpr bool isFloat =
      std::is_floating_point_v<CPPTY> || onnx_mlir::isSmallFPType<CPPTY>;
...
DEFINE_BTypeCppTypeTraits(BType::FLOAT16, onnx_mlir::float_16);
DEFINE_BTypeCppTypeTraits(BType::BFLOAT16, onnx_mlir::bfloat_16);
DEFINE_BTypeCppTypeTraits(BType::FLOAT8E4M3FN, onnx_mlir::float_8e4m3fn);
DEFINE_BTypeCppTypeTraits(BType::FLOAT8E4M3FNUZ, onnx_mlir::float_8e4m3fnuz);
DEFINE_BTypeCppTypeTraits(BType::FLOAT8E5M2, onnx_mlir::float_8e5m2);
DEFINE_BTypeCppTypeTraits(BType::FLOAT8E5M2FNUZ, onnx_mlir::float_8e5m2fnuz);
